...
\title{\boldmath Initial Notes for Boundary CFT}
\author{X. D. H.}

\maketitle

\begin{abstract}
  This is my primary learning notes for Boundary Conformal Field
  Theory (BCFT). This note stands for my initial understanding of the
  subject. It contains probably many assumptions and ideas that I'm
  not really convinced of. However, topics are proven to be correct
  in some sense(for I learn them from several books and lecture
  notes). Thus, I hope this note could be a good starting point for
  my future study of BCFT.
\end{abstract}
