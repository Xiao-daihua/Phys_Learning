...
\begin{abstract}
  I recently came to review some basic concepts in Conformal Field Theory (CFT) for some semester projects. When going through the renowned textbook "Conformal Field Theory" by Di Francesco, Mathieu, and Sénéchal, I found it structures poorly in chapter 4-6, without a clear logical flow and indication of the core concepts. Thus, I write this note for myself to extract the essential ideas from the book and emplasize the core concepts in CFT. This note is by no means complete or rigorous, but I hope it can serve as a concise reference for myself and others who want to get a quick overview of CFT.
\end{abstract}
...
\newpage 
\section{Introduction to Conformal Bootstrap}\label{sec:Introduction to Conformal Bootstrap} % (fold)
\input{bootstrap.tex}
