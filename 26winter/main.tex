...
\title{\boldmath Note on Minicourse of RMT, Quantum Chaos and 2D Gravity}
\author{X. D. H.}

\maketitle

\begin{abstract}
  This is a note for Prof. Verlinde's minicourse on the topic of RMT and 2D Gravity in the swissmap winter school in 2026.
\end{abstract}

\tableofcontents

\section{Lecture 1: Fundamental RMTs}\label{sec:Lecture 1: Fundamental RMTs} % (fold)
\input{lec1.tex}
% section Lecture 1: Fundamental RMTs (end)
