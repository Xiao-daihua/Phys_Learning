...
\subsection{Phase Space Analysis (Witten)}
...
\rmk{
  ...
  rigorous. Though we can construct the solutions, we also have left
  the problem that the quotienting may lead to manifold with
  undesirable properties, though being flat.

  In the final section \cref{sec:Quantization of 3D} we will view the
