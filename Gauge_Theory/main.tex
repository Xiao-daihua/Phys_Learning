...
\title{\boldmath Initials on QFT and Gauge Theory Notes}
\author{X. D. H.}

\maketitle

\begin{abstract}
  This is my note on David Tong's lectures on QFT. I'll give a summary of some results in Gauge Theory and Lattice Gauge Theory.
\end{abstract}

\tableofcontents

\newpage 
\section{Classical Dirac Field}\label{sec:Classical Dirac Field} % (fold)
\input{cdf.tex}
% section Classical Dirac Field (end)

\newpage 
\section{Yang-Mills Theory}\label{sec:Yang-Mills Theory} % (fold)
\input{ymt.tex}
% section Yang-Mills Theory (end)


\newpage 
\section{Lattice Gauge Theory}\label{sec:Lattice Gauge Theory} % (fold)
\input{lgt.tex}
% section Lattice Gauge Theory (end)
