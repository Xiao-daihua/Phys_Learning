...
\title{\boldmath Initial Note on Quantization of Techmuller Space and CFT}
\author{X. D. H.}

\maketitle

\begin{abstract}
  This is my reading note for the topic of Quantization of Teichmuller Space and Conformal Field Theory. I'll maily focus on the paper by Verlinde, while adding some of the background material as well as my own understanding and comments.
\end{abstract}

\tableofcontents

\section{Basic}\label{sec:Basic} % (fold)
\input{tml.tex}
% section Basic (end)
